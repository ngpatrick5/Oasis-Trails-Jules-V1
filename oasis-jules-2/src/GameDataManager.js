const GameDataManager = {
    ...
    loadProfile: function() {
        const savedDataString = localStorage.getItem('oasisJules2Profile');
    ...
    saveProfile: function() {
        ...
        localStorage.setItem('oasisJules2Profile', jsonString);
        console.log("Profile Saved!", this.profile);
    },

    resetProfile: function() {
        localStorage.removeItem('oasisJules2Profile');
        this.loadProfile();
