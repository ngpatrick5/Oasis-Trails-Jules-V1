class LevelSelectScene extends Phaser.Scene {
    ...
    drawMenuBackground() {
        ...
        const columnHeight = height - header.displayHeight - footer.displayHeight;
        const leftColumn = this.add.image(0, header.displayHeight, 'menu_vertical_column').setOrigin(0, 0);
        leftColumn.setDisplaySize(leftColumn.width, columnHeight);
        const rightColumn = this.add.image(width, header.displayHeight, 'menu_vertical_column').setOrigin(1, 0).setFlipX(true);
